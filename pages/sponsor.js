...
export default class SponsorPage extends React.Component {
  render() {
    return (
      <Page>
        <SponsorContainer>
          <Title>Syntax Sponsorship</Title>
          <p>
          ...
          <Subtitle>Audience Size && Breakdown</Subtitle>
          ...
          <Subtitle>Audience Interests</Subtitle>
          <p>
          ...
          <Subtitle>What You'll Get && Pricing</Subtitle>
          <p>
          ...
          <Subtitle>Case Study: DevLifts</Subtitle>
          <p>
